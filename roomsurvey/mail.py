...
def survey_reminder_mail(recipients):
    for r in recipients:
        ...
        body = ("Hello,\n\n"
                "You're receiving this email because one or more member(s) of your syndicate\n"
                "have not yet completed the room preferences form.\n\n"
		...
		"It would be very helpful for us if you could make sure you have completed it\n"
		"by the end of today. If not, we will try and be as flexible as possible, but\n"
		"if there is a particular reason why you or your syndicate might not be able\n"
		"to complete the form by this evening, please do get in touch with us and we\n"
